...
function Stepper({ onUp, onDown }: { onUp: () => void; onDown: () => void }) {
  const cls =
    'flex h-3.5 w-[18px] items-center justify-center rounded border text-[8px] leading-none text-muted-foreground transition-colors hover:border-primary hover:text-primary'
  return (
