...
const teams: Team[] = [
  // Group A
  { id: 'MEX', name: '멕시코', nameEn: "Mexico", flagCode: 'mx', groupId: 'A' },
  { id: 'KOR', name: '대한민국', nameEn: "Korea Republic", flagCode: 'kr', groupId: 'A' },
  { id: 'CZE', name: '체코', nameEn: "Czechia", flagCode: 'cz', groupId: 'A' },
  { id: 'RSA', name: '남아프리카 공화국', nameEn: "South Africa", flagCode: 'za', groupId: 'A' },
  // Group B
  { id: 'CAN', name: '캐나다', nameEn: "Canada", flagCode: 'ca', groupId: 'B' },
  { id: 'SUI', name: '스위스', nameEn: "Switzerland", flagCode: 'ch', groupId: 'B' },
  { id: 'BIH', name: '보스니아 헤르체고비나', nameEn: "Bosnia and Herzegovina", flagCode: 'ba', groupId: 'B' },
  { id: 'QAT', name: '카타르', nameEn: "Qatar", flagCode: 'qa', groupId: 'B' },
  // Group C
  { id: 'BRA', name: '브라질', nameEn: "Brazil", flagCode: 'br', groupId: 'C' },
  { id: 'MAR', name: '모로코', nameEn: "Morocco", flagCode: 'ma', groupId: 'C' },
  { id: 'SCO', name: '스코틀랜드', nameEn: "Scotland", flagCode: 'gb', groupId: 'C' },
  { id: 'HAI', name: '아이티', nameEn: "Haiti", flagCode: 'ht', groupId: 'C' },
  // Group D
  { id: 'USA', name: '미국', nameEn: "United States", flagCode: 'us', groupId: 'D' },
  { id: 'AUS', name: '오스트레일리아', nameEn: "Australia", flagCode: 'au', groupId: 'D' },
  { id: 'PAR', name: '파라과이', nameEn: "Paraguay", flagCode: 'py', groupId: 'D' },
  { id: 'TUR', name: '튀르키예', nameEn: "Türkiye", flagCode: 'tr', groupId: 'D' },
  // Group E
  { id: 'GER', name: '독일', nameEn: "Germany", flagCode: 'de', groupId: 'E' },
  { id: 'CIV', name: '코트디부아르', nameEn: "Côte d'Ivoire", flagCode: 'ci', groupId: 'E' },
  { id: 'ECU', name: '에콰도르', nameEn: "Ecuador", flagCode: 'ec', groupId: 'E' },
  { id: 'CUW', name: '쿠라소', nameEn: "Curaçao", flagCode: 'cw', groupId: 'E' },
  // Group F
  { id: 'NED', name: '네덜란드', nameEn: "Netherlands", flagCode: 'nl', groupId: 'F' },
  { id: 'JPN', name: '일본', nameEn: "Japan", flagCode: 'jp', groupId: 'F' },
  { id: 'SWE', name: '스웨덴', nameEn: "Sweden", flagCode: 'se', groupId: 'F' },
  { id: 'TUN', name: '튀니지', nameEn: "Tunisia", flagCode: 'tn', groupId: 'F' },
  // Group G
  { id: 'EGY', name: '이집트', nameEn: "Egypt", flagCode: 'eg', groupId: 'G' },
  { id: 'IRN', name: '이란', nameEn: "IR Iran", flagCode: 'ir', groupId: 'G' },
  { id: 'BEL', name: '벨기에', nameEn: "Belgium", flagCode: 'be', groupId: 'G' },
  { id: 'NZL', name: '뉴질랜드', nameEn: "New Zealand", flagCode: 'nz', groupId: 'G' },
  // Group H
  { id: 'ESP', name: '스페인', nameEn: "Spain", flagCode: 'es', groupId: 'H' },
  { id: 'URU', name: '우루과이', nameEn: "Uruguay", flagCode: 'uy', groupId: 'H' },
  { id: 'CPV', name: '카보베르데', nameEn: "Cabo Verde", flagCode: 'cv', groupId: 'H' },
  { id: 'KSA', name: '사우디아라비아', nameEn: "Saudi Arabia", flagCode: 'sa', groupId: 'H' },
  // Group I
  { id: 'NOR', name: '노르웨이', nameEn: "Norway", flagCode: 'no', groupId: 'I' },
  { id: 'FRA', name: '프랑스', nameEn: "France", flagCode: 'fr', groupId: 'I' },
  { id: 'SEN', name: '세네갈', nameEn: "Senegal", flagCode: 'sn', groupId: 'I' },
  { id: 'IRQ', name: '이라크', nameEn: "Iraq", flagCode: 'iq', groupId: 'I' },
  // Group J
  { id: 'ARG', name: '아르헨티나', nameEn: "Argentina", flagCode: 'ar', groupId: 'J' },
  { id: 'AUT', name: '오스트리아', nameEn: "Austria", flagCode: 'at', groupId: 'J' },
  { id: 'JOR', name: '요르단', nameEn: "Jordan", flagCode: 'jo', groupId: 'J' },
  { id: 'ALG', name: '알제리', nameEn: "Algeria", flagCode: 'dz', groupId: 'J' },
  // Group K
  { id: 'COL', name: '콜롬비아', nameEn: "Colombia", flagCode: 'co', groupId: 'K' },
  { id: 'COD', name: '콩고민주공화국', nameEn: "DR Congo", flagCode: 'cd', groupId: 'K' },
  { id: 'POR', name: '포르투갈', nameEn: "Portugal", flagCode: 'pt', groupId: 'K' },
  { id: 'UZB', name: '우즈베키스탄', nameEn: "Uzbekistan", flagCode: 'uz', groupId: 'K' },
  // Group L
  { id: 'ENG', name: '잉글랜드', nameEn: "England", flagCode: 'gb', groupId: 'L' },
  { id: 'GHA', name: '가나', nameEn: "Ghana", flagCode: 'gh', groupId: 'L' },
  { id: 'PAN', name: '파나마', nameEn: "Panama", flagCode: 'pa', groupId: 'L' },
  { id: 'CRO', name: '크로아티아', nameEn: "Croatia", flagCode: 'hr', groupId: 'L' },
]
